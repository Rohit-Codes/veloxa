...
const faqData = [
	{
		...
		answer:
			"The timeline depends on the scope of your project. A standard business website typically takes 2–4 weeks, while a more complex project — like an e-commerce store or custom web application — can take 6–10 weeks. At Veloxa, we work with a clear project timeline from day one so you always know what's happening and when to expect delivery.",
	},
	{
		question: "How much does a website cost?",
		answer:
			"Most business websites start from an affordable base price of ₹10,000, and we'll give you a clear breakdown before any work begins.",
	},
	{
		question: "Will my website be optimized for Google and SEO?",
		answer:
			"Absolutely. Every website Veloxa builds is engineered for SEO from the ground up — this includes proper heading structure (H1, H2, H3), meta tags, alt text on all images, fast page load speeds, mobile responsiveness, and clean semantic HTML. We also ensure your site scores 90+ on Core Web Vitals, which is a key ranking factor for Google in 2024 and beyond.",
	},
	{
		question: "Will my website work on mobile and all devices?",
		answer:
			"Yes — 100%. All websites we build are fully responsive, meaning they look and perform perfectly on smartphones, tablets, laptops, and desktop screens. We design mobile-first, which means your mobile experience is never an afterthought — it's the foundation.",
	},
	{
		question:
			"Do you provide support and maintenance after the website goes live?",
		answer:
			"Yes, we do. Launching your website is just the beginning. We offer ongoing support and maintenance packages that cover security updates, performance monitoring, content changes, and technical fixes. You'll never be left alone after handover — we're a long-term partner, not a one-time vendor.",
	},
	{
		question:
			"Can you redesign my existing website instead of building from scratch?",
		answer:
			"Absolutely. If you already have a website that feels outdated, slow, or isn't converting visitors into customers, we can redesign and rebuild it from the ground up — keeping your brand identity while dramatically improving performance, design, and SEO. We start with a full audit of your current site so we know exactly what to fix and what to improve.",
	},
];
					...
					{faqData.map((q, index) => {
						...
						return (
							<div
								...
								} ${isOpen ? "bg-white/60 shadow-sm" : "bg-transparent"} ${
									isOpen && "px-4 md:px-4 -mx-4 md:-mx-4 rounded-xl"
								}`}
							>
								<button
								...
								>
									<div
										className={`faq-answer-inner transition-opacity duration-300 ease-in-out ${
											isOpen ? "opacity-100" : "opacity-0"
										}`}
									>
